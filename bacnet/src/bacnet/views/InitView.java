...
public class InitView implements SelectionListener {
    ...
    public void createPartControl(Composite parent) {
        ...
        gd_composite_Intro.widthHint = 1000;
        ...
        gd_composite_11.widthHint = 1000;
        ...
        btnGeneView = new Button(composite_15, SWT.NONE);
        ...
        gd_composite_16.widthHint = 1000;
    ...
    public void pushState() {
        NavigationManagement.pushStateView(InitView.ID);
    }
